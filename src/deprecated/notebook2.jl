...
# ╔═╡ 65121c5c-f6ac-11ed-1354-b5469a67a27a
begin
using DataFrames, PlutoUI, HypertextLiteral
PlutoUI.TableOfContents(title="Table of Contents", indent=true)
end

# ╔═╡ 35f622fb-3425-48c2-8348-91fdec97d495
begin 
...
# ╔═╡ ec923ab6-e4e3-45ff-8303-57a0e96a233f
begin 
...
# ╔═╡ 63a1faf0-ae18-4db7-9dc7-5d1251a0a2b2
md"""
...
# ╔═╡ af403d18-ad24-4be3-9c5a-1a6891e64564
md"""
### Table 1
"""

# ╔═╡ d6a56068-e4aa-4dcf-be24-b1c5690f407a
DataFrame(
...
# ╔═╡ dacb1783-a726-4f4e-bf24-fcbe81f71f56
md"""
### Figure 2: Image Map
"""

# ╔═╡ 322a3cde-d836-431f-a43e-ec0493d78744
md"""
### Table 4: Alternative GCS Models
"""

# ╔═╡ 3969fec0-9e17-4f2d-8e33-6e68d699c215
let 
...
# ╔═╡ 02c54b65-636d-4396-a2f5-77884361ab91
md"""
### GCS Computation
...
# ╔═╡ 945beb9c-1817-409d-9918-c22275a8b930
df = CSV.read("../../data/data_for_regression.csv", DataFrame, limit=30) |> 
(data -> select(data, [:imglink, :fem_body, :fem_face]))

# ╔═╡ dc5afaa2-4aa1-4d5d-83a4-abe23d78e339
begin
	df_features = @showprogress [pysqueeze(resmodel(pypreprocess(pyload(impath * x)))) for x in df.imglink ]
	#df_features = mapreduce(permutedims, vcat, features)
end

# ╔═╡ 21dac73d-fbb2-4fd6-b8ca-bc5e5530ec02
begin
	probs = DataFrame(fem_body = calsvm.predict_proba(mapreduce(permutedims, vcat, df_features))[:, 2])
	probs.fem_body ≈ df.fem_body
end
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "1f9fe1c3f5be38f86fb92606e926c42e8a4051fd"
